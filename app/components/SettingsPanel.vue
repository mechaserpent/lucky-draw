  ...
  <div class="settings-panel">
    <div class="settings-section">
      ...
      <div class="setting-row">
        ...
        <input
          type="text"
          v-model="localSettings.siteIconLeft"
      ...
      <div class="setting-row">
        ...
        <input
          type="text"
          v-model="localSettings.siteIconRight"
          class="input input-small"
          maxlength="4"
          :disabled="disabled"
        />
      ...
      <div class="setting-row">
        ...
        <input
          type="text"
          v-model="localSettings.siteSubtitle"
          class="input"
          :disabled="disabled"
        />
      </div>
    ...
    <div class="settings-section">
      ...
      <div class="color-grid">
        <div class="color-item">
          ...
          <input
            type="color"
            v-model="localSettings.themePrimary"
            :disabled="disabled"
          />
        ...
        <div class="color-item">
          ...
          <input
            type="color"
            v-model="localSettings.themeSecondary"
            :disabled="disabled"
          />
        ...
        <div class="color-item">
          ...
          <input
            type="color"
            v-model="localSettings.themeAccent"
            :disabled="disabled"
          />
    ...
    <div class="settings-section">
      ...
      <div class="color-grid">
        <div class="color-item">
          ...
          <input
            type="color"
            v-model="localSettings.themeBgFrom"
            :disabled="disabled"
          />
        ...
        <div class="color-item">
          ...
          <input
            type="color"
            v-model="localSettings.themeBgTo"
            :disabled="disabled"
          />
        ...
        <div class="color-item">
          ...
          <input
            type="color"
            v-model="localSettings.themeBgDeep"
            :disabled="disabled"
          />
    ...
    <div class="settings-section">
      ...
      <div class="theme-presets">
        <button class="preset-btn ocean" @click="applyPreset('ocean')">
          🌊 海洋
        </button>
        <button class="preset-btn christmas" @click="applyPreset('christmas')">
          🎄 聖誕節
        </button>
        <button class="preset-btn newyear" @click="applyPreset('newyear')">
          🧧 新年
        </button>
        <button class="preset-btn party" @click="applyPreset('party')">
          🎉 派對
        </button>
      </div>
    </div>
...
const { settings, updateSettings, resetSettings, getDefaultSettings } =
  useDynamicConfig();
...
function saveAndClose() {
  ...
  const snowflakeChanged =
    localSettings.showSnowflakes !== settings.value.showSnowflakes;
...
.preset-btn.ocean {
  background: linear-gradient(135deg, #102a43, #3b9797);
  color: #fff;
}
