<template>
  <div>
    ...
    <div v-else-if="error" class="card error-card">
      ...
      <h3>{{ error }}</h3>
      <button class="btn btn-primary" @click="$router.push('/')">返回首頁</button>
    </div>
    ...
    <template v-else-if="resultData">
      <div class="celebration-container">
        ...
        <div class="info-banner">
          <div class="info-item">
            <span class="info-icon">{{ resultData.mode === 'solo' ? '🖥️' : '🌐' }}</span>
            <span class="info-text">{{ resultData.mode === 'solo' ? '主持模式' : '連線模式' }}</span>
          </div>
          <div class="info-item">
      ...
      <div class="modal-content share-modal">
        ...
        <div class="social-share-section">
          ...
          <div class="social-buttons">
            ...
            <button class="social-share-btn" @click="shareToSocial('instagram')" title="Instagram">
              <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <button class="social-share-btn" @click="shareToSocial('copy')" title="複製連結">
              <svg viewBox="0 0 24 24" fill="currentColor">
